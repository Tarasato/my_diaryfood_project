// ignore_for_file: prefer_const_constructors, must_be_immutable, sort_child_properties_last, use_build_context_synchronously, prefer_interpolation_to_compose_strings, no_leading_underscores_for_local_identifiers, unused_field, unused_local_variable
...
//method ดึงตําแหน่งปัจจุบัน
  ...
  void initState() {
    _getCurrentLocation();
    //เอาข้อมูลที่ส่งมาแสดงในหน้าแก้ไข
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: _imageSelected == null
                              ? NetworkImage(
                                  '${Env.hostName}/mydiaryfood/assets/images/picupload/foods/${widget.diaryfood!.foodImage}',
                                )
                              : FileImage(
                                  _imageSelected!,
                                ),
                    ...
                    if (foodShopnameCtrl.text.trim() == '') {
                      ...
                      if (foodShopnameCtrl.text.trim() == '') {
                        ...
                        CallAPI.callUpdateDiaryFoodAPI(diaryfood).then((value) {
                          if (value.message == '1') {
                            showCompleteDialog(
                                    context, 'แก้ไขบันทึกการกินสำเร็จ!')
                                .then((value) {
                              Navigator.pop(context);
                            });
                          } else {
                            showWaringDialog(context,
                                'แก้ไขบันทึกการกินไม่สำเร็จ! กรุณาลองใหม่อีกครั้ง');
                          }
                        });
                      }
                    }
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      CallAPI.callDeleteDiaryFoodAPI(diaryfood).then((value) {
                        if (value.message == '1') {
                          showCompleteDialog(context, 'ลบบันทึกการกินสำเร็จ!')
                              .then((value) {
                            Navigator.pop(context);
                          });
                        } else {
                          showWaringDialog(context,
                              'ลบบันทึกการกินไม่สำเร็จ! กรุณาลองใหม่อีกครั้ง');
                        }
                      });
                    });
                  },
